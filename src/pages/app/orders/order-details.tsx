                    ...
                    <Table>
                            ...
                            {order.orderItems.map((item) => {
                                return (
                                    <TableRow key={item.id}>
                                        ...
                                        <TableCell
                                            className={"text-right"}>{(item.priceInCents / 100).toLocaleString("pt-BR", {
                                            style: 'currency',
                                            currency: 'BRL'
                                        })}</TableCell>
                                        <TableCell
                                            className={"text-right"}>{(item.priceInCents * item.quantity / 100).toLocaleString('pt-Br', {
                                            style: 'currency',
                                            currency: 'BRL'
                                        })}</TableCell>
                                    </TableRow>
                        ...
                        <TableFooter>
                            <TableRow>
                                ...
                                <TableCell
                                    className={"text-right font-medium"}>{(order.totalInCents / 100).toLocaleString('pt-BR', {
                                    style: 'currency',
                                    currency: 'BRL'
                                })}</TableCell>
                            </TableRow>
